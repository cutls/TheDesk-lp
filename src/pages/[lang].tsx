...
const ja = {
	...
	macNotice: 'Apple Siliconのみに対応。公証されており、セキュリティ設定の変更は必要ありません。Intel Macで利用したい場合は、App Store版をご利用ください。',
...
const en = {
	...
	macNotice: 'for Apple Silicon only. It is notarized and does not require any changes to your security settings. If you want to use it on an Intel Mac, please use the App Store version.',
