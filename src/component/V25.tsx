import { Alert, AlertDescription, AlertIcon, AlertTitle, Badge, Box, Button, ButtonGroup, Code, Container, Flex, Heading, Image, Link, Stat, StatArrow, StatGroup, StatHelpText, StatLabel, StatNumber, Tab, TabList, TabPanel, TabPanels, Tabs, Text } from '@chakra-ui/react'
...
const a: React.FC<IProps> = (props: IProps) => {
    ...
    return (
        <Container centerContent={true} p={10} maxW={650}>
                ...
                <Tabs w={600} maxW="calc(100vw - 2rem)">
                    ...
                    <TabPanels>
                        <TabPanel>
                            ...
                            <Text fontWeight="bold">{t.installer}(msi)<Badge ml={2} mt={-1} colorScheme={getColorOfCodename(files.semanticVersion)} textTransform="initial">{files.semanticVersion} ({files.codename})</Badge></Text>
                            <ButtonGroup>
                        ...
                        <TabPanel>
                            <Text fontWeight="bold" mt={3}>{t.download}<Badge ml={2} mt={-1} colorScheme={getColorOfCodename(files.semanticVersion)} textTransform="initial">{files.semanticVersion} ({files.codename})</Badge></Text>
                            <ButtonGroup>
            ...
            <ButtonGroup mt={5}>
                <Button as="a" href="https://www.patreon.com/cutls" target="_blank" rel="noopener" colorScheme="teal">Patreon</Button>
                <Button as="a" href="https://www.pixiv.net/fanbox/creator/28105985" target="_blank" rel="noopener" colorScheme="teal">Pixiv FANBOX</Button>
                <Button as="a" href="https://liberapay.com/cutls" target="_blank" rel="noopener" colorScheme="teal">Liberapay</Button>
            </ButtonGroup>
            <Box h={20} />
            <StatGroup w={600} maxW="100%" borderColor="#E2E8F0" borderWidth={1} p={3} mb={10} borderRadius={5}>
                ...
                {files.lastDls >= 1000 && <Stat>
                    <StatLabel>DL of <Badge colorScheme={getColorOfCodename(files.lastVersion)} textTransform="initial">{files.lastVersion} ({files.lastCodename})</Badge></StatLabel>
